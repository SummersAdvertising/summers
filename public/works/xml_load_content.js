...
xml.onreadystatechange=function()
{
	...
	{			
		...
		while( xmldoc.getElementsByTagName('article')[i] != undefined && xmldoc.getElementsByTagName('article')[i] != null ) {
			...
			if (xarticle.getElementsByTagName('content')[0].childNodes[0].wholeText == undefined) {
				obj.content = xarticle.getElementsByTagName('content')[0].childNodes[0].nodeValue;
			} else {
				obj.content = xarticle.getElementsByTagName('content')[0].childNodes[0].wholeText;
			}
	          
			obj.link = xarticle.getElementsByTagName('link')[0].childNodes[0].nodeValue;
